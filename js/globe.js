...
function startGlobe(){
  ...
  var locs=[
    {name:'Karnataka, India',lat:15.3,lng:75.1,col:0x8B5CF6,hex:'139,92,246',tag:'WHERE IT STARTED',tagBg:'#f0eeff',tagCol:'#6D28D9',proj:'Medical Officer \u00b7 Integrative Physician',desc:'Practiced as an integrative physician in primary care and community health. Redesigned clinic EHR workflows and led public health outreach. Founded an 800+ member mentoring community for naturopathy graduates.'},
